...
void MainMenu_OnLoadMap(sHashTreeVarClient * apClient)
{
	...
	if( lpEvent )
	{
		if( eGUIEVENT_BUTTON_LEFTCLICK == lpEvent->mEvent )
		{
			...
			String_Update( gMainMenuClass.mFSs[ eMM_FS_MAP ].mpTitle, "LOAD MAP" );
...
void MainMenu_OnSaveMap(sHashTreeVarClient * apClient)
{
	...
	if( lpEvent )
	{
		if( eGUIEVENT_BUTTON_LEFTCLICK == lpEvent->mEvent )
		{
			...
			String_Update( gMainMenuClass.mFSs[ eMM_FS_MAP ].mpTitle, "SAVE MAP" );
...
void MainMenu_OnLoadPrj(sHashTreeVarClient * apClient)
{
	...
	if( lpEvent )
	{
		if( eGUIEVENT_BUTTON_LEFTCLICK == lpEvent->mEvent )
		{
			...
			String_Update( gMainMenuClass.mFSs[ eMM_FS_PRJ ].mpTitle, "LOAD PROJECT" );
...
void MainMenu_OnSavePrj(sHashTreeVarClient * apClient)
{
	...
	if( lpEvent )
	{
		if( eGUIEVENT_BUTTON_LEFTCLICK == lpEvent->mEvent )
		{
			...
			String_Update( gMainMenuClass.mFSs[ eMM_FS_PRJ ].mpTitle, "SAVE PROJECT" );
...
void MainMenu_OnLoadBin(sHashTreeVarClient * apClient)
{
	...
	if( lpEvent )
	{
		if( eGUIEVENT_BUTTON_LEFTCLICK == lpEvent->mEvent )
		{
			...
			String_Update( gMainMenuClass.mFSs[ eMM_FS_MAP ].mpTitle, "LOAD BIN" );
...
void MainMenu_OnSaveBin(sHashTreeVarClient * apClient)
{
	...
	if( lpEvent )
	{
		if( eGUIEVENT_BUTTON_LEFTCLICK == lpEvent->mEvent )
		{
			...
			String_Update( gMainMenuClass.mFSs[ eMM_FS_MAP ].mpTitle, "SAVE BIN" );
