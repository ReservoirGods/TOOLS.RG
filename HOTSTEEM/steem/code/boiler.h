...
HMENU mem_browser_menu,history_menu,logsection_menu,profiler_menu;
HMENU menu1;
...
typedef struct{
  ...
  char name[64];
  char BreakCondition[128];
  ExpressionEvaluator::sEE_Expression	BreakExpression;
}DEBUG_ADDRESS;
